    ...
    LemuroidCardSettingsGroup(
        ...
        LemuroidSettingsList(
            state = indexPreferenceState(
                id = R.string.pref_key_theme,
                default = "system",
                values = stringListResource(R.array.pref_key_theme_values),
            ),
            title = { Text(text = stringResource(id = R.string.settings_title_theme)) },
            items = stringListResource(R.array.pref_key_theme_display_names),
        )
        ...
        LemuroidSettingsSwitch(
            state = booleanPreferenceState(R.string.pref_key_boot_bios, true),
            title = { Text(text = stringResource(id = R.string.settings_title_boot_bios)) },
            subtitle = { Text(text = stringResource(id = R.string.settings_description_boot_bios)) },
        )
        LemuroidSettingsSwitch(
            state = immersiveMode,
